...
@section('content')
    ...
    <nav class="navbar navbar-expand-lg bg-navbar-theme rounded">
        <div class="container-fluid">
            <a class="navbar-brand" href="javascript:void(0)">Buku telepon</a>
            ...
            <div class="collapse navbar-collapse" id="navbar-ex-5">
                ...
                <ul class="navbar-nav ms-lg-auto">
                    <li class="nav-item">
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-label-add">Add Buku telepon</button>
                    </li>
                </ul>
            </div>
        </div>
